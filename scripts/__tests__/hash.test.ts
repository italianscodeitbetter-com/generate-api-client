    ...
    it("is deterministic", () => {
      ...
      try {
        ...
        writeFileSync(
          ...
          `// Auto-generated by api-client-generate. Edit apiClient.augment.ts for overrides (that file is never overwritten).

export { augmentApiClient } from "./apiClient.augment.js";
`,
        );
        writeFileSync(
          join(dir, "apiClient.augment.ts"),
          `// Overrides and bypasses for the generated API client. This file is not overwritten by the generator.
